...
public class Addition
{
	public static void main(String[] args) throws AWTException 
	{
		...
		ele1.click();
		WebElement ele2 = driver.findElement(By.xpath("//div[@class = 'PaQdxb mF5fo']//div[@jsname = 'XSr6wc']"));
		ele2.click();
		WebElement ele3 = driver.findElement(By.xpath("//div[@class = 'PaQdxb A2W7l']//div[@jsname = 'T7PMFe']"));
		boolean num_8 = ele3.isEnabled();
		if (num_8)
		{
	    ...
	    System.out.println("Addition of the above numbers 7 and 8 is " + result);
	    if (result=="15")
		{
